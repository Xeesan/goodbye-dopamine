        ...
        <div className="glass-card">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div>
              ...
              <input type="date" id="task-date" className="input-simple" defaultValue={new Date().toISOString().split('T')[0]} />
            </div>
            <div>
              <label className="form-label">TIME</label>
              <input type="time" id="task-time" className="input-simple" defaultValue="12:00" />
            </div>
          </div>
          ...
          <div className="priority-group">
            {['low', 'medium', 'high'].map(p => (
              <button key={p} className={`priority-btn ${priority === p ? 'active' : ''}`} onClick={() => setPriority(p)}>
                {p.toUpperCase()}
              </button>
            ))}
          </div>
          ...
          <button className="btn-green w-full" onClick={createTask}>
