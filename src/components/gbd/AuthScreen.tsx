      ...
      <div className="glass-card-accent w-full max-w-[440px] p-10 animate-[slideUp_0.5s_ease]">
        ...
        {isLogin ? (
          <div>
            ...
            <button className="btn-primary-auth" onClick={() => onLogin(loginId.trim(), loginPassword.trim())}>
              Sign In <span>→</span>
            </button>
            ...
            <button className="btn-outline w-full flex items-center justify-center gap-2" onClick={() => alert('QR Login feature coming soon!')}>
          ...
          <div>
            ...
            <button className="btn-primary-auth" onClick={() => onSignup(signupName.trim(), signupPassword.trim())}>
              Sign Up <span>→</span>
            </button>
