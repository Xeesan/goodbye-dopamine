...
export const QUOTES_BN: Quote[] = [
  ...
  { text: "তোমরা আল্লাহর উপর ভরসা করো, যদি তোমরা সত্যিকারের মুমিন হও।", author: "আল-কুরআন (৫:২৩)" },
  { text: "আল্লাহ কোনো আত্মার উপর তার সাধ্যের বাইরে বোঝা চাপান না।", author: "আল-কুরআন (২:২৮৬)" },
  ...
  { text: "জ্ঞান অর্জন করা প্রত্যেক মুসলিমের উপর ফরজ।", author: "হাদীস (ইবনে মাজাহ)" },
  { text: "যে ব্যক্তি আল্লাহকে ভয় করে, আল্লাহ তার জন্য পথ বের করে দেন।", author: "আল-কুরআন (৬৫:২)" },
  { text: "ধৈর্য ধারণ করো, নিশ্চয়ই আল্লাহ ধৈর্যশীলদের সাথে আছেন।", author: "আল-কুরআন (২:১৫৩)" },
  ...
  { text: "তোমরা অবশ্যই ধৈর্য ও নামাজের মাধ্যমে সাহায্য প্রার্থনা করো।", author: "আল-কুরআন (২:৪৫)" },
  { text: "উত্তম চরিত্রের চেয়ে ভারী কিছু নেই মীযানে।", author: "হাদীস (আবু দাউদ)" },
];
