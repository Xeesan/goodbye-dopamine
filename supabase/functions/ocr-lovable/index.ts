...
// Rate limit config: 10 requests per 60 seconds per user
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.error("OCR Lovable error:", err);
    return new Response(
